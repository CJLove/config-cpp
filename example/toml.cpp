// Sample application using ConfigCpp to handle toml-based configuration file
...
int main(int argc, char**argv)
{
    ...
    config.AddConfigPath("../inputs/toml/");
    config.AddConfigPath("../../inputs/toml/");
    ...
    if (config.ReadInConfig()) {
        ...
        TomlConfig configData;
        if (config.UnmarshalToml<TomlConfig>(configData)) {
