...
static const std::string yamlLiteral = R"(---
top-string: bob
top-int: 10
top-double: 1.1234
top-bool: true
...
nested-list:
  - 
    - nested-item1-subitem1
    - nested-item1-subitem2
  - 
    - nested-item2=subitem1
    - nested-item2-subitem2
nested-dict:
  key1: 
...
TEST(YamlHandlerTest, IsSet) {
    ConfigCpp::YamlHandler h(yamlLiteral);
